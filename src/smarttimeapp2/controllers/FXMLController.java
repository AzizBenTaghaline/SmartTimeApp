...
public class FXMLController implements Initializable {
    ...
    // ✅ AJOUT : Instance partagée des appareils (comme pour l'historique)
    ...
    private void afficherAppareils() {
        ...
        try {
            ...
            // ✅ MODIFICATION : Utiliser l'instance partagée
    ...
    private void afficherSessions() {
        ...
        try {
            ...
            // ✅ AJOUT : Passer les appareils partagés
            controller.setAppareils(getAppareils());
    ...
    private void initializeDemoSessions() {
        try {
            // ✅ UTILISER les appareils partagés pour les sessions démo
    ...
    // ✅ MODIFICATION : Retourner l'instance partagée des appareils
